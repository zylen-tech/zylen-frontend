...
const Footer = () => (
  ...
  >
    <div className="mx-auto max-w-7xl p-5 pb-8 pt-14 md:p-8">
      <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div className="sm:col-span-2 md:col-span-1">
          ...
          <div className="flex flex-col gap-1.5 text-sm text-white/60">
            ...
            <span className="text-xs">{BRAND.businessHours}</span>
          </div>
          ...
          <div className="mt-5 flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex size-8 items-center justify-center rounded-lg bg-white/10 text-white/60 transition-colors duration-150 hover:bg-white/20 hover:text-white"
              aria-label="LinkedIn"
            >
              <LinkedInIcon />
            </a>
