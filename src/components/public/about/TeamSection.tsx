    ...
    <div className="mx-auto max-w-7xl px-5 md:px-8">
      ...
      <div className="grid gap-6 sm:grid-cols-3">
        {ABOUT.team.map((member, i) => (
          ...
          >
            <div className="mb-4 flex size-20 items-center justify-center rounded-full bg-brand-500 font-montserrat text-2xl font-extrabold text-white">
              {member.name.charAt(0)}
            </div>
            <h4 className="font-montserrat text-base font-bold text-brand-500">
              {member.name}
            </h4>
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-brand-500 transition-opacity duration-150 hover:opacity-70"
            >
